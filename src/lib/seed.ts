...
const photos = {
  coffee: assetPath("/food/coffee.jpg"),
  latte: assetPath("/food/latte.jpg"),
  tea: assetPath("/food/tea.jpg"),
  hotChocolate: assetPath("/food/hot-chocolate.jpg"),
  lemonade: assetPath("/food/lemonade.jpg"),
  lassi: assetPath("/food/lassi.jpg"),
  soda: assetPath("/food/soda.jpg"),
  water: assetPath("/food/water.jpg"),
  fries: assetPath("/food/fries.jpg"),
  momo: assetPath("/food/momo.jpg"),
  noodles: assetPath("/food/noodles.jpg"),
  pakoda: assetPath("/food/pakoda.jpg"),
  sausage: assetPath("/food/sausage.jpg"),
  wings: assetPath("/food/wings.jpg"),
  dalbhat: assetPath("/food/dalbhat.jpg"),
  friedRice: assetPath("/food/fried-rice.jpg"),
  burger: assetPath("/food/burger.jpg"),
  pizza: assetPath("/food/pizza.jpg"),
  thukpa: assetPath("/food/thukpa.jpg"),
  pancakes: assetPath("/food/pancakes.jpg"),
  omelette: assetPath("/food/omelette.jpg"),
  oats: assetPath("/food/oats.jpg"),
};
