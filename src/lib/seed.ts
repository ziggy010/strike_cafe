...
const photos = {
  coffee: assetPath("/food/coffee.webp"),
  latte: assetPath("/food/latte.webp"),
  tea: assetPath("/food/tea.webp"),
  hotChocolate: assetPath("/food/hot-chocolate.webp"),
  lemonade: assetPath("/food/lemonade.webp"),
  lassi: assetPath("/food/lassi.webp"),
  soda: assetPath("/food/soda.webp"),
  water: assetPath("/food/water.webp"),
  fries: assetPath("/food/fries.webp"),
  momo: assetPath("/food/momo.webp"),
  noodles: assetPath("/food/noodles.webp"),
  pakoda: assetPath("/food/pakoda.webp"),
  sausage: assetPath("/food/sausage.webp"),
  wings: assetPath("/food/wings.webp"),
  dalbhat: assetPath("/food/dalbhat.webp"),
  friedRice: assetPath("/food/fried-rice.webp"),
  burger: assetPath("/food/burger.webp"),
  pizza: assetPath("/food/pizza.webp"),
  thukpa: assetPath("/food/thukpa.webp"),
  pancakes: assetPath("/food/pancakes.webp"),
  omelette: assetPath("/food/omelette.webp"),
  oats: assetPath("/food/oats.webp"),
};
...
export function seedDB(): DB {
  ...
  return {
    ...
    combos: [
      {
        ...
        nameNe: "म्याच डे कम्बो",
        photo: photos.burger,
        itemIds: ["i-burger", "i-lemonade"],
        price: 480, // vs 380 + 120 = 500
        active: true,
        popular: true,
      },
      {
        ...
        nameNe: "मम + दूध चिया",
        photo: photos.momo,
        itemIds: ["i-vegmomo", "i-milktea"],
        price: 190, // vs 150 + 80 = 230
        active: true,
        popular: true,
      },
      {
        id: "combo-dalbhat-lassi",
        name: "Dal Bhat + Lassi",
        nameNe: "दाल भात + लस्सी",
        photo: photos.dalbhat,
        itemIds: ["i-dalbhat", "i-lassi"],
        price: 420, // vs 350 + 120 = 470
        active: true,
        popular: false,
      },
    ],
    ...
    settings: {
      ...
      soundOn: true,
      currency: "NPR",
      paymentQr: { enabled: false, staticData: "" },
    },
  };
}
