...
const dict = {
  ...
  all: { en: "All", ne: "सबै" },
  searchPlaceholder: { en: "Search the menu…", ne: "मेनु खोज्नुहोस्…" },
  searchResults: { en: "Results", ne: "नतिजा" },
  noResults: { en: "Nothing matched", ne: "केही भेटिएन" },
  noResultsHint: { en: "Try another word or clear the filters.", ne: "अर्को शब्द वा फिल्टर हटाएर हेर्नुहोस्।" },
  clearSearch: { en: "Clear", ne: "हटाउनुहोस्" },
  ...
  combos: { en: "Combo deals", ne: "कम्बो अफर" },
  comboSave: { en: "Save", ne: "बचत" },
  bundle: { en: "Bundle", ne: "प्याकेज" },
  promoCode: { en: "Promo code", ne: "प्रोमो कोड" },
  promoPlaceholder: { en: "Enter code", ne: "कोड लेख्नुहोस्" },
  apply: { en: "Apply", ne: "लागू" },
  discount: { en: "Discount", ne: "छुट" },
  promoApplied: { en: "Code applied", ne: "कोड लागू भयो" },
  promoInvalid: { en: "That code isn't valid", ne: "यो कोड मिलेन" },
  promoExpired: { en: "That code has expired", ne: "यो कोडको समय सकियो" },
  promoMin: { en: "Order a bit more to use this code", ne: "यो कोडका लागि अलि बढी अर्डर गर्नुहोस्" },
